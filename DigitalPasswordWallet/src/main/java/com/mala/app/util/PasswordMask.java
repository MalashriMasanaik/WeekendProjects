...
public class PasswordMask {
	...
	public PasswordMask() throws Exception {
		myEncryptionKey = "ThisIsSpartaThisIsSparta";
		//myEncryptionKey = "AllisWell2019"; java.security.InvalidKeyException: Wrong key size
	...
	public String encryptPsw(String unencryptedString) {
	...
	public String decryptPsw(String encryptedString) {
