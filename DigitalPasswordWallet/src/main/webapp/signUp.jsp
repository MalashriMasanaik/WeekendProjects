...
Mobile No:<input type="text" name="mobileNo" id="mobileNo" maxlength="10" size="10"/> 
...
<input type="submit" value="submit" name="submit" /> <input type="submit" value="clear" name="clear" />
</pre>
</form>
</body>
</html>
